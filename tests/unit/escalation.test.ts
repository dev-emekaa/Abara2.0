...
describe("detectEscalation — red-flag phrases must escalate", () => {
  const RED_FLAGS: Array<[string, string]> = [
    ...
    ["seizure", "i am having muscle spasms and seizures"],
    ["chest-pain", "i have chest pains"],
    ["severe-worsening-pain", "these are severe pains"],
    ["severe-bleeding", "i have severe bleeds"],
