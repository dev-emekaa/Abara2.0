...
export const demoNudges: Nudge[] = [
  {
    ...
    userId: demoUser.id,
    kind: "FOLLOWUP",
    title: "Time for your malaria check-in",
    body: "It's day 4 since you started treatment. A quick two-minute check-in helps catch anything that isn't settling the way it should.",
  ...
  },
  {
    ...
    userId: demoUser.id,
    kind: "MEDICATION",
    title: "One last dose to go",
    body: "Today is the final day of your malaria course. Finishing it completely is what stops the malaria coming back, even though you already feel better.",
  ...
  },
  {
    ...
    userId: demoUser.id,
    kind: "SEASONAL",
    title: "Rainy season is here in Enugu",
    body: "Mosquitoes are out in force around you right now. Two minutes on bed-net use could save you another round of malaria.",
    deepLink: "/app/timeline",
    status: "PENDING",
